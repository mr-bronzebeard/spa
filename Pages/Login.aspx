                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:TextBox ID="PasswordTextBox" runat="server" placeholder="ПАРОЛЬ" CssClass="form-control"></asp:TextBox>
                            <asp:Button ID="LoginButton" runat="server" OnClick="LoginButton_Click" Text="ВХОД"  CssClass="btn btn-info"/>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <!-- CONTENT -->
